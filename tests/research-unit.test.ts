...
describe('Research - Unit Tests', () => {
  beforeEach(() => {
    ...
    // Mock SessionManager to prevent real network calls
    jest.spyOn(SessionManager.prototype, 'initialize').mockResolvedValue();
    jest.spyOn(SessionManager.prototype, 'post').mockResolvedValue(mockResearchResponse);
  });
