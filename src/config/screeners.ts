/**
 * Yahoo Finance predefined screener configurations.
 * Each screener has a description, unique ID, and title.
 */
...
/**
 * Get list of all available screener keys
 */
export function getAvailableScreeners(): string[] {
  return Object.keys(SCREENERS);
}

/**
 * Get screener configuration by key
 */
export function getScreenerConfig(key: string): ScreenerConfig | undefined {
  return SCREENERS[key];
}

/**
 * Check if a screener key is valid
 */
export function isValidScreener(key: string): boolean {
  return key in SCREENERS;
}
